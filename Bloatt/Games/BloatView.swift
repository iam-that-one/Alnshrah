...
struct BloatView :View {
    ...
    @AppStorage("FirstArrayBloat") var defaults: Int = 0 // to save data into userDefaults
    @AppStorage("SecondArrayBloat") var defaults2: Int = 0 // to save data into userDefaults
    @State var array = UserDefaults.standard.array(forKey: "FirstArrayBloat") // to store data from userDefaults
    @State var array2 = UserDefaults.standard.array(forKey: "SecondArrayBloat") // to store data from userDefaults
                        ...
                        HStack(spacing: 70){
                            ...
                            Button(action:{
                                if score1 != ""{
                                    ...
                                    UserDefaults.standard.set(arrayOfValues1, forKey: "FirstArrayBloat") // to save data into userDefaults
                                ...
                                if score2 != ""{
                                    ...
                                    UserDefaults.standard.set(arrayOfValues2, forKey: "SecondArrayBloat") // to save data into userDefaults
                    ...
                    HStack(spacing: 50){
                        ...
                        .alert(isPresented: $replay) {
                            Alert(title: Text("تحذير"), message: Text("هل تريد إعادة اللعبة، سوف يتم حذف جميع بيانات اللعبة المخزنة!!"), primaryButton: .default(Text("احذفها")){
                                ...
                                array = []
                                array2 = []
                                UserDefaults.standard.removeObject(forKey: "FirstArrayBloat")
                                UserDefaults.standard.removeObject(forKey: "SecondArrayBloat")
